...
#define MAC(Acc, A, B) Acc += (int64_t) A * (int64_t) B;
#define MSU(Acc, A, B) Acc -= (int64_t) A * (int64_t) B;
...
/**
   @brief  Q32 Fixed-point DWT on real input data.
