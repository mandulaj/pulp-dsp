 ...
 * Title:        plp_dwt_q16s_xpulpv2.c
 * Description:  Q16 Fixed-point Discret Wavelet Transform for XPULPV2
 *
 * $Date:        10. Juli 2021
 * $Revision:    V1
 *
...
/**
   ...
   @return      none
*/
void plp_dwt_haar_u_q16s_xpulpv2(const int16_t *__restrict__ pSrc,
                         uint32_t length,
                         plp_dwt_extension_mode mode,
                         int16_t *__restrict__ pDstA,
                         int16_t *__restrict__ pDstD) {
